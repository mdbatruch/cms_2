    ...
    <?php while($nav_subject = mysqli_fetch_assoc($nav_subjects)) { ?>
     <?php //if (!$nav_subject['visible']){ continue; }?>
      <li class="<?php if ($nav_subject['id'] == $subject_id) {echo 'selected';}?>">
        <a href="<?php echo url_for('index.php?subject_id=' . chars(u($nav_subject['id']))); ?>">
          ...
          <ul class="pages">
            <?php while($nav_page = mysqli_fetch_assoc($nav_pages)) { ?>
              ...
              <li class="<?php if ($nav_page['id'] == $page_id) {echo 'selected';}?>">
                <a href="<?php echo url_for('index.php?subject=' . chars(u($nav_page['menu_name'])) . '&page=' . chars(u($nav_page['menu_name']))); ?>">
